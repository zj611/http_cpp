...
namespace httplib {
  ...
  std::string proxy_digest_auth_password_;
    ...
    public:
        // Universal interface
        explicit Client();//just for download!!
        ...
        bool inline downloadAs(std::string url, std::string filepath);
...
#include <curl/curl.h>
    bool inline Client::downloadAs(std::string url, std::string filepath)
    {
        CURL * m_curl;
